...
import (
	...
	v34 "github.com/envoyproxy/go-control-plane/envoy/extensions/wasm/v3"
...
type Bootstrap struct {
	...
	WasmService                  []*v34.WasmService          `protobuf:"bytes,21,rep,name=wasm_service,json=wasmService,proto3" json:"wasm_service,omitempty"`
...
func (m *Bootstrap) GetWasmService() []*v34.WasmService {
	if m != nil {
...
func (m *Bootstrap_StaticResources) GetListeners() []*v35.Listener {
	if m != nil {
		return m.Listeners
	}
	return nil
...
func (m *Bootstrap_StaticResources) GetClusters() []*v36.Cluster {
	if m != nil {
		return m.Clusters
	}
	return nil
...
func (m *Bootstrap_StaticResources) GetSecrets() []*v37.Secret {
	if m != nil {
		return m.Secrets
	}
	return nil
...
var fileDescriptor_ccaa5ae7dd0aa495 = []byte{
	...
	,
}
